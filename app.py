...
<style>
  ...
  html, body, .stApp { background: #080c18 !important; color: var(--text) !important; }
  .stApp,
  ...
  textarea::placeholder, .stTextArea textarea::placeholder { color: rgba(255,255,255,0.25) !important; }
